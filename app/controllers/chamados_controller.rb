class ChamadosController < ApplicationController
  ...
  private
    ...
    def chamado_params
      params.require(:chamado).permit(:numero_solicitacao, :data_solicitacao, :sexo, :idade, :codigo_bairro, :bairro, :origem_chamado, :situacao_chamado, :tipo_chamada, :motivo_descarte, :tipo_ocorrencia)
    end
end
